...
$MediaPlayer.Source = "\\am_monroe\vol2\SHARE\Security Training\Psychology of Robbery\Psychology of Robbery Part1.mp4"
...
New-WPFMessageBox -Content $StackPanel -Title "Windows 10 In The Enterprise" -TitleBackground CornflowerBlue
#New-WPFMessageBox -Title "Tool Center" -TitleBackground CornflowerBlue  -ButtonType Yes-No
